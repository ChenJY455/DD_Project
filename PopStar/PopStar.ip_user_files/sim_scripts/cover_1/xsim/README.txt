...
#
# Generated by export_simulation on Sat Jan 06 19:22:50 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './cover.sh' script.
...
./cover.sh -noclean_files

For more information on the script, please type './cover.sh -help'.
